		...
		try{
			if (null != requestBStream){
				...
				if (obj != null && obj instanceof WSBaseRequest){
					...
					IBusinessAction action = ActionFactory.getActionInstance(ActionDirectory.ACTION_REPORTS);
					response = action.execute(request, ERequestType.REPORT_SUB_REQUEST);
			...
			logger.debug("|~| Report Sub Service |~| Stream Convresion Exception occurred during the serivce execution : " + scEx.getMessage());
			...
			logger.debug("|~| Report Sub Service |~| Business Exception occurred during the serivce execution : " + bEx.getMessage());
			...
			logger.debug("|~| Report Sub Service |~| Bad Request Exception occurred during the serivce execution : " + brEx.getMessage());
			...
			logger.debug("|~| Report Sub Service |~| Application Exception occurred during the serivce execution : " + aEx.getMessage());
			...
			logger.debug("|~| Report Sub Service |~| Throwable occurred during the serivce execution : " + th.getMessage());
