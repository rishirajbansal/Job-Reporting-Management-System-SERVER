		...
		try{
			if (null != requestBStream){
				...
				if (obj != null && obj instanceof WSBaseRequest){
					...
					IBusinessAction action = ActionFactory.getActionInstance(ActionDirectory.ACTION_SYNCHER);
					response = action.execute(request, ERequestType.SYNCHER_REQUEST);
			...
			logger.debug("|~| Sync Service |~| Stream Convresion Exception occurred during the serivce execution : " + scEx.getMessage());
			...
			logger.debug("|~| Sync Service |~| Business Exception occurred during the serivce execution : " + bEx.getMessage());
			...
			logger.debug("|~| Sync Service |~| Bad Request Exception occurred during the serivce execution : " + brEx.getMessage());
			...
			logger.debug("|~| Sync Service |~| Application Exception occurred during the serivce execution : " + aEx.getMessage());
			...
			logger.debug("|~| Sync Service |~| Exception occurred during the serivce execution : " + ex.getMessage());
			...
			logger.debug("|~| Sync Service |~| Throwable occurred during the serivce execution : " + th.getMessage());
